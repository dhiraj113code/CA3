...
% Create figure
figure1 = figure('Name','Problem 2 : Instruction Cache');
...
% Create title
title({'For Instruction Cache : Hit Rate vs Block Size', '(Cache Size = 8KB, Write back, Write allocate, Associativity = 2)'});
