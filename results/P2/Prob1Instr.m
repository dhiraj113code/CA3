function Prob1Instr(X1, YMatrix1)
...
% Create figure
figure1 = figure('Name','Problem 1 : Instruction Cache');
...
% Create title
title({'For Instruction Cache : Hit Rate vs Cache Size', '(Block size = 4B, Write back, Write allocate, Fully Associative)'});
